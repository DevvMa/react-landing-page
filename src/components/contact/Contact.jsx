            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">maulanadevva.fitrah@gmail.com</span>

                        <a href="mailto:maulanadevva.fitrah@gmail.com" className="contact__button">
                            Write me{" "}
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">+62 857 3148 7284</span>

                        <a href="https://api.whatsapp.com/send?phone=6285731487284&text=Hello Devva!, Lets Collaborate" className="contact__button">
                            Write me{" "}
                            <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                        </a>
                    </div>
